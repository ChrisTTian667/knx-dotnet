...
namespace Knx.Tests
{
    ...
    public class DatapointTypes27XXXTests
    {
        ...
        {
            var dpt1 = new Dpt4ByteCombinedInfoOnOff(true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true);
