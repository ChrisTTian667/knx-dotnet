...
namespace Knx.Common
{
    public sealed class ByteArrayToken
    {
        ...
        public int BytesToAdd { get; private set; }
    ...
    public class ByteArrayBuilder
    {
        ...
        {
            this._list.AddRange(array);
            return this;
        }

        public ByteArrayBuilder Add(IPAddress ipAddress)
        {
            this._list.AddRange(ipAddress.GetAddressBytes());
            return this;
        }
        ...
        public ByteArrayBuilder AddByte(byte? b)
        {
            ...
            this._list.Add((byte)b);
            return this;
        }

        public ByteArrayBuilder AddInt(int integer)
        {
            this.Add(IntToByteArray(integer));
